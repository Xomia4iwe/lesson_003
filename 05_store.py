...
for furniture in goods:
    ...
    furniture_code = goods[furniture]
    furniture_quantity = 0
    furniture_cost = 0
    for i in store[furniture_code]:
        furniture_quantity += i['quantity']
        furniture_cost += i['price'] * i['quantity']


        print(furniture_name, furniture_quantity, ' шт., стоимость ',  furniture_cost, ' рублей')
